<template>
  <component :is="wetherIconComponent"></component>
</template>

<script>
import Cloudy from './weather-icons/Cloudy.vue';
import Flurries from './weather-icons/Flurries.vue';
import Rainy from './weather-icons/Rainy.vue';
import Sunny from './weather-icons/Sunny.vue';
import SunShower from './weather-icons/SunShower.vue';
import ThunderStorm from './weather-icons/ThunderStorm.vue';
  ...
  setup(props) {
    ...
    const proxyHandler = {
      get: function(target, name) {
        return name in target ? target[name] : Cloudy;
      },
    };

    const weatherIconsProxy = new Proxy(weatherIcons, proxyHandler);

    const wetherIconComponent = computed(
      () => weatherIconsProxy[weather.value]
    );

    return { wetherIconComponent };
  },
};
</script>
