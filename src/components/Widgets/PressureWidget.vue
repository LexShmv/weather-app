  ...
  <WidgetContainer>
    <template #icon>
      ...
      >
        <g>
          <path
            d="M401.17,68.83C356.785,24.444,297.771,0,235,0S113.215,24.444,68.83,68.83C24.444,113.216,0,172.229,0,235
		...
		s220,98.691,220,220S356.309,455,235,455z"
          />
          <path
            d="M235,30C121.962,30,30,121.963,30,235s91.962,205,205,205s205-91.963,205-205S348.038,30,235,30z M235,425
		...
		S265.289,375.5,261.147,375.5z"
          />
          <path
            d="M251.147,360.5c4.142,0,7.5-3.357,7.5-7.5s-3.358-7.5-7.5-7.5h-32.294c-4.142,0-7.5,3.357-7.5,7.5s3.358,7.5,7.5,7.5
		H251.147z"
          />
        </g>
      </svg>
    ...
    <template #info>
      <p>
        <span class="info__data">{{ pressureMM }}</span> mmHg
      </p>
    </template>
  </WidgetContainer>
</template>
...
export default {
  ...
  setup(props) {
    const pressureMM = computed(() => toMM(props.pressure));
    return { pressureMM };
  },
};
</script>
...
<style>
.arrow__rotate {
  animation: spin-arrow 3s linear infinite 3s;
  transform-origin: center center;
}
.up__arrow {
  animation: up-arrow 3s ease 1;
  transform-origin: center center;
}
@keyframes up-arrow {
  0% {
